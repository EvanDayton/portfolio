...
import { OutlinePass } from "https://cdn.skypack.dev/three@0.134.0/examples/jsm/postprocessing/OutlinePass.js";
...
loader.load("./objects/scene.gltf", (gltf) => {
  ...
  window.addEventListener("wheel", (e) => {
    ...
    currentCameraPositionZ +=
      (targetCameraPositionZ - currentCameraPositionZ) * 0.1; // Smoothing factor
